...
I64QSpinBox::I64QSpinBox(Product::prodContent * prod, QWidget *parent) :
...
qlonglong I64QSpinBox::value() const
{
    return m_value;
}

void I64QSpinBox::setValue(qlonglong expectedNewValue)
{
...
QString I64QSpinBox::prefix() const
{
    return m_prefix;
}

void I64QSpinBox::setPrefix(const QString &prefix)
{
    m_prefix = prefix;
...
QString I64QSpinBox::suffix() const
{
    return m_suffix;
}

void I64QSpinBox::setSuffix(const QString &suffix)
{
    m_suffix = suffix;
...
QString I64QSpinBox::cleanText() const
{
    return QString::number(m_value);
}

qlonglong I64QSpinBox::singleStep() const
{
    return m_singleStep;
}

void I64QSpinBox::setSingleStep(qlonglong step)
{
    m_singleStep = step;
}

qlonglong I64QSpinBox::minimum() const
{
    return m_minimum;
}

void I64QSpinBox::setMinimum(qlonglong min)
{
    m_minimum = min;
...
qlonglong I64QSpinBox::maximum() const
{
    return m_maximum;
}

void I64QSpinBox::setMaximum(qlonglong max)
{
    m_maximum = max;
    if (m_maximum < m_minimum) {
        m_maximum = m_minimum;
...
void I64QSpinBox::setRange(qlonglong min, qlonglong max)
{
    if (min < max) {
        m_minimum = min;
        m_maximum = max;
...
void I64QSpinBox::keyPressEvent(QKeyEvent *event)
{
    switch (event->key()) {
    case Qt::Key_Enter:
    case Qt::Key_Return:
...
void I64QSpinBox::focusOutEvent(QFocusEvent *event)
{
    lineEditEditingFinalize();
...
QAbstractSpinBox::StepEnabled I64QSpinBox::stepEnabled() const
{
    if (isReadOnly()) {
        return 0;
    }
...
void I64QSpinBox::stepBy(int steps)
{
    if (isReadOnly()) {
        return;
    }
...
QValidator::State I64QSpinBox::validate(QString &input, int &pos) const
{
...
void I64QSpinBox::lineEditEditingFinalize()
{
...
void I64QSpinBox::selectCleanText()
{
